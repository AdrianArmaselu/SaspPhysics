...
_case(meeting_time1(Object1, Object2), d(D), s1(S1), s2(S2), meeting_time1(Unknown)):- not _numeric_answer(enabled).
...
_case(wtc(Object1, Object2), d1(D1), d2(D2), s1(S1), s2(S2), will_trains_collide(Unknown)):- not _numeric_answer(enabled).
...
_case(downstream_time(Object1, Object2), bs(BS), rs(RS), ut(UT), downstream_time(Unknown)):- not _numeric_answer(enabled).
...
_case(upstream_time(Object1, Object2), bs(BS), rs(RS), dt(DT), upstream_time(Unknown)):- not _numeric_answer(enabled).
...
_case(upstream_time1(Object1, Object2), d(D), rs(RS), bs(BS), upstream_time1(Unknown)):- not _numeric_answer(enabled).
